...
public class Lblock implements Block{
    ...
    private Color kleur = Color.ORANGE;
    ...
    Lblock(int x,int y) {
        //constructor
        this.setAllXCoord(x, x - 30, x + 30, x -30);
        this.setAllYCoord(y, y, y, y + 30);
    ...
    public void rotate(){
        if (x1 < 270 && x1 > 0 && y1 < 510){
            if (rotatenr == 1){
                this.setAllXCoord(x1, x2 + 30, x3 - 30, x4);
                this.setAllYCoord(y1, y2 - 30, y3 + 30, y4 - 60);
                rotatenr = 2;
            }else if (rotatenr == 2){
                this.setAllXCoord(x1, x2 + 30, x3 - 30, x4 + 60);
                this.setAllYCoord(y1, y2 + 30, y3 - 30, y4);
                rotatenr = 3;
            }else if (rotatenr == 3){
                this.setAllXCoord(x1, x2 - 30, x3 + 30, x4);
                this.setAllYCoord(y1, y2 + 30, y3 - 30, y4 + 60);
